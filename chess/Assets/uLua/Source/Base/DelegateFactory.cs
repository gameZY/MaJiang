...
public static class DelegateFactory
{
	...
	public static void Register(IntPtr L)
	{
		...
		dict.Add(typeof(SDKManager.SDKFinish), new DelegateValue(SDKManager_SDKFinish));
	...
	public static Delegate SDKManager_SDKFinish(LuaFunction func)
	{
		SDKManager.SDKFinish d = (param0) =>
		{
			int top = func.BeginPCall();
			IntPtr L = func.GetLuaState();
			LuaScriptMgr.Push(L, param0);
